...
/// 
[System.Serializable]
public class ClassSynergyTable : ScriptableObject 
{
    ...
    public ClassSynergyTableData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new ClassSynergyTableData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public ClassSynergyTableData FindByKey(string key)
    //{
